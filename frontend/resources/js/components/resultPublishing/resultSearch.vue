                    ...
                    <div class="row mb-3">
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" class="form-control" :class="[(v$.queue_no.$error)?'is-invalid':'']"
                                   id="queue_no" v-model="queue_no" name="queue_no">
        ...
        methods: {
            ...
            async searchForm() {
                ...
                if (await this.v$.$validate()) {
                    ...
                    this.isLoading = true;
                    var axiosObj = this.axios.get(process.env.MIX_API_URL + '/appointment/view/result', {params: params})
                        .then(response => {
                            this.status = true;
                            that.sendToPage(this.status, response);
