            ...
            <div class="card-body">
                ...
                >
                    ...
                    <template class="align-right" #cell(actions)="row">
                        <button v-if="$root.hasAccess('ShiftSetupPage', 'edit')"  v-b-tooltip.hover title="Edit" type="button" class="btn btn-primary btn-sm mb-1"
    ...
    export default {
        ...
        data() {
            return {
                ...
                fields: [
                    ...
                    {key: 'center_name', label: 'Center Name', sortable: false, sortDirection: 'desc', tdClass: "p-1"},
                    {
                        key: 'shift_start',
                        label: 'Start Time',
                        sortable: true,
                        ...
                        formatter: (value, key, item) => {
                            return (new Date((new Date()).toDateString()+' '+value).toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true }));
                        },
                        tdClass: "p-1"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        sortDirection: 'desc',
                        formatter: (value, key, item) => {
                            return (value.trim() == 'Y') ? 'Active' : 'Inactive';
                        },
                        tdClass: (value, key, item) => {
                            return ( value.trim() == 'Y') ? ' text-success' : ' text-danger';
                        },
                    },
        ...
        methods: {
            ...
            async getTableData() {
                ...
                this.axios
                    .get(process.env.MIX_API_URL + '/shift-setup', {params: params})
                    .then(response => {
